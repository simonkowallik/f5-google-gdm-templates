...
def GenerateConfig(context):
  ...
  if ALLOWUSAGEANALYTICS == "yes":
      ...
      SENDANALYTICS = ' --metrics "cloudName:google,region:' + context.properties['region'] + ',bigipVersion:' + context.properties['imageName'] + ',customerId:${CUSTOMERID},deploymentId:${DEPLOYMENTID},templateName:f5-existing-stack-byol-3nic-bigip.py,templateVersion:v1.3.1_simonkowallik_git.io/fAZZj,licenseType:byol"'
  else:
      CUSTHASH = ''
      SENDANALYTICS = ''
  resources = [{
